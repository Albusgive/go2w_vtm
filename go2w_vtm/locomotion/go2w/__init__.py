...
gym.register(
    id="Rough-Mimic-GRU-Unitree-Go2W",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_mimic_env_cfg:UnitreeGo2WMimicEnvCfg",
...
gym.register(
    id="Rough-Multi-Motion-Unitree-Go2W",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_multi_motion_env_cfg:UnitreeGo2WMultiMotionEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:Go2WRoughMultiMotionPPORunnerCfg",
    },
)

gym.register(
    id="Rough-Multi-Motion-Unitree-Go2W-Distill-CNN",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_multi_motion_env_distill_cfg:UnitreeGo2WMultiMotionEnvDistillCfg",
        "rsl_rl_distillation_cfg_entry_point": (
