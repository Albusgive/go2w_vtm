...
@configclass
class UnitreeGo2WFaltJumphEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.height_scanner_down = None
        self.scene.height_scanner_up = None
        ...
        self.observations.policy.velocity_commands.params["asset_cfg"].body_names = [self.base_link_name]
        self.observations.critic.velocity_commands.params["asset_cfg"].body_names = [self.base_link_name]
        ...
        self.rewards.base_height_l2_ref.weight = -5.0
        ...
        self.rewards.base_height_l2_ref = None
        
        self.rewards.base_height_l2.weight = -0.0
        self.rewards.base_height_l2.params["target_height"] = 0.40
        self.rewards.base_height_l2.params["asset_cfg"].body_names = [self.base_link_name]
        
        self.rewards.feet_pos_in_pit_l2.weight = -6.0
        self.rewards.feet_pos_in_pit_l2.params["asset_cfg"].body_names = self.foot_link_names
        self.rewards.base_pos_in_pit_l2.weight = -100.0
        ...
        # Jump-tracking rewards
        self.rewards.jump_track_l2.weight = -0.0 # TODO -15
        self.rewards.jump_track_vel_l2.weight = -0.0 # TODO -30.0
        self.rewards.jump_collection_leg_l2.weight = -0.0
        self.rewards.jump_collection_leg_l2.params["asset_cfg"].body_names = self.collection_leg_names
        
        # no Reference-free jump 用jump_state更新跳跃状态
        self.commands.jump_track.enable_track = False # 关闭轨迹使用无规划跳跃
        self.rewards.jump_linv_z.weight = 40.0
        self.rewards.jump_lowing_joint_pos_exp.weight = 20.0
        self.rewards.jump_lowing_joint_pos_exp.params["asset_cfg"]
        self.rewards.jump_land_height_exp.weight = 0.0
        self.rewards.jump_land_height_exp.params["target_height"] = 0.8
        self.rewards.jump_foot_contact_std.weight = -0.1 # 方差
        self.rewards.jump_foot_contact_std.params["sensor_cfg"].body_names = self.foot_link_names
        ...
        if self.__class__.__name__ == "UnitreeGo2WFaltJumphEnvCfg":
        ...
        # 无规划跳跃
        self.terminations.jump_state.params["sensor_cfg"].body_names = self.foot_link_names
        self.terminations.jump_state.params["asset_cfg"].body_names = self.foot_link_names
        self.terminations.jump_state.params["lowing_time"] = 0.8
        ...
        self.commands.base_velocity.is_lin_vel_z_zero = True
        
        
        self.observations.policy.jump_acc_commands.scale=0.025 # 0.025
        self.commands.jump_acc.ranges.lin_acc_z = (1.0, 1.0) # 有参考轨迹 35-45 无参考 1
        self.commands.jump_acc.acc_z_probability = 0.0
        self.commands.jump_acc.joint_pos = self.low_joint_pos
        # debug
        # self.commands.jump_acc.start_cmd = 0.0
        # self.commands.jump_acc.acc_z_probability = 1.0
        # self.events.randomize_reset_base.params["pose_range"]["z"]=(5.0, 5.0)
