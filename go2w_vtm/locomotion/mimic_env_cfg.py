...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        velocity_command = ObsTerm(func=mdp.motion_velocity_command, params={"command_name": "motion"})
...
@configclass
class MimicEnvCfg(ManagerBasedRLEnvCfg):
