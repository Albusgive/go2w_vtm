...
from isaaclab.sensors import ContactSensorCfg, RayCasterCfg, patterns, RayCasterCameraCfg,FrameTransformerCfg
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    specific_transforms = FrameTransformerCfg(
        ...
        target_frames=[
            ...
            FrameTransformerCfg.FrameCfg(prim_path="{ENV_REGEX_NS}/Robot/FR_calf"),
            FrameTransformerCfg.FrameCfg(prim_path="{ENV_REGEX_NS}/Robot/RL_thigh"),
            FrameTransformerCfg.FrameCfg(prim_path="{ENV_REGEX_NS}/Robot/RR_hip"),
